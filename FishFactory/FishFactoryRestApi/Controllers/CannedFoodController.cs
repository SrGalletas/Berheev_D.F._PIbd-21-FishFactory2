...
{
    public class CannedFoodController : ApiController
    {
        private readonly ICannedFoodService _service;
        public CannedFoodController(ICannedFoodService service)
        {
            _service = service;
        }
        [HttpGet]
        ...
        [HttpPost]
        public void DelElement(CannedFoodBindingM model)
        {
